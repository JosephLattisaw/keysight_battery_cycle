...
public:
    ...
    void abort(const ViSession &session, std::string cell_list) const;
    ...
    void clear(const ViSession &session, std::string cell_list) const;
    ...
    void define(const ViSession &session, std::string cell_id, std::string channel_list) const;
    ...
    void enable(const ViSession &session, std::string cell_list, std::string sequence_id) const;
    ...
    void initiate(const ViSession &session, std::string cell_list) const;
